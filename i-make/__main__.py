...
render_make.making_overlay_image_kahentyou_test("i-make/static/facepaints/black_png.png")
...
with mp_face_mesh.FaceMesh(
    ...
    while cap.isOpened():
        ...
        if results.multi_face_landmarks:
            ...
            effected_image = render_make.makeup(target_image, np.array(landmarks), False)
        else:
